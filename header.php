				...
				<div class="navbar-menu">
					...
					<div class="navbar-end">
						<a class="navbar-item" onclick="wnd_ajax_modal('wndt_search_form')">
							<button class="button is-outlined is-small">搜索</button>
						</a>
						<a class="navbar-item" onclick="wnd_ajax_modal('wndt_demand_form')">
							<button class="button is-outlined is-small">发布需求</button>
						</a>
							...
							<div class="navbar-item has-dropdown is-hoverable">
								...
								<div class="navbar-dropdown is-right">
									...
									<?php if (is_super_admin()) {?>
										<a class="navbar-item" href="<?php echo home_url('ucenter/submit?type=company'); ?>">添加公司</a>
										<a class="navbar-item" href="<?php echo home_url('ucenter/submit?type=post'); ?>">发布文章</a>
									<?php }?>
